%%
% get % of ROIs and PCs with BTSP, and plateau rate
...
%%
% plot average plateau rate of the PCs with BTSP
WT = PCs_plateau_rate_WT;
RTT = PCs_plateau_rate_RTT;
...
%print(gcf, 'suppfig3_3.pdf','-dpdf','-vector','-bestfit');
